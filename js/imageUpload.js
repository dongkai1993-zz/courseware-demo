var initImageUpload = function (wdBoard) {
    if (navigator.userAgent.indexOf('HUAWEI') != -1 || navigator.userAgent.indexOf('XiaoMi') != -1) {
        var imgUploader = Qiniu.uploader({
            ...
            uptoken_url: $('#uptoken_url')[0].value, //若未指定uptoken_url,则必须指定 uptoken ,uptoken由其他程序生成
            domain: $('#domain')[0].value, //bucket 域名，下载资源时用到，**必需**
